...
const link_provider_1 = require("./entities/link.provider");
...
exports.LinkModule = LinkModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [...link_provider_1.linkProviders, ...source_provider_1.sourceProviders, link_service_1.LinkService],
    })
], LinkModule);
